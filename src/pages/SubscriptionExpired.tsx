      ...
      >
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
          ...
          <p className="text-gray-300 text-center mb-8">
            Your Free Tier Kayinnu Poyello.. To continue please renew your subscription
          </p>
          ...
          <div className="space-y-3">
           ...
           <button className="w-full bg-white/10 hover:bg-white/20 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 border border-white/20 flex items-center justify-center gap-2">
           <Mail className="w-5 h-5" />
           <a href="https://moggstack.netlify.app/">Contact Support</a>
            </button>
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <p className="text-gray-400 text-sm text-center">
              Need help? Reach out to <a href="https://moggstack.netlify.app/">moggstack technologies</a>
            </p>
          </div>
        </div>
